...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                @foreach ($schoolMeans as $index => $schoolMean)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $schoolMean['school']->name }}</td>
                        <td>{{ $schoolMean['school']->county }}</td>
                        <td>{{ $schoolMean['total_ranked_students'] }}</td>
                        <td>{{ $schoolMean['school_mean'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
